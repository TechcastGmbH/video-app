...
- The JS and CSS files of the Plyr video player can be found in "public/static/" and referenced with "/static". Check the Plyr documentation for more info on how to initialize the video player. Check in the browser developer console if Plyr is really loaded. Potentially the video is being played by the browser directly. When Plyr is running no menu will open when you right-click on the video. Also per default it will run in the whole browser area.
